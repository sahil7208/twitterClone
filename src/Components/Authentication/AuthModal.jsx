    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          {location.pathname === "/signup"?"Create Account":"Signin"}
          </h1>
          ...
          <Button variant='outlined' fullWidth onClick={handleNavigate} sx={{borderRadius:"29px", py:"15px" , width:"100%"}} size="large"
          >
